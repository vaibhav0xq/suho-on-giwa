...
| Assay route, checkpoints, recipient reading, and settlement path. | Wallet session, recipient measurement, guarded send, and settlement status. |
| ![Suho overview sample reading](./public/dashboard-ending.png) | ![Suho console activity ledger](./public/console-ending.png) |
| Protocol view for a live reading before release. | On-chain activity split across All, Sent, Incoming, and Closed states. |
